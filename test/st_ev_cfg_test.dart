...
// void main() {
//   test('''asks which rules to config for listView (TV) on MarketView screen 
...
//     final askWhichRulesForMktVwTblVw = QuestBase.ruleSelectQuest(
//       qq,
//       prompts,
//       questId: QuestionIdStrings.specRulesForAreaOnScreen,
//     );

//     _questMgr.appendNewQuestions([askWhichRulesForMktVwTblVw]);
